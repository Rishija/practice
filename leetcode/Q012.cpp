...
public:
    ...
    string helper(int num) {
        ...
        if(num < 40)   return string(num / 10, 'X') + helper(num % 10);
        if(num < 50)   return "XL" + helper(num % 10);
        
        if(num < 90)   return "L" + helper(num - 50);
        ...
        return string(num/1000, 'M') + helper(num % 1000);
    }
